...
pair inequality of Theorem VII.66, in exact rational and interval arithmetic
(the proof of Theorem VII.70).
...
the following is established.
  ...
  2.  The bound B = N (N f_0 - f(1)) / 2 - N F(1,1,1) / (6 (N - 2)), with
      ...
      its closed form (the integrals in Proposition VII.65 are elementary):
...
hypothesis of Theorem VII.66.  The script prints what it verifies and
