#!/usr/bin/env python3
"""
The extendability criterion of Proposition VII.35 and the reduction of
Corollary VII.36 to the saturated 23-point case.
...
Checks, in order:
  ...
  6  the chain of Corollary VII.36: at most 22 contacts gives at least
...
def main():
    ...
    record("the chain of Corollary VII.36 holds numerically",
