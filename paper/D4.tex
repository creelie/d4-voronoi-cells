...
\texttt{explicit\_eps0.py} and \texttt{three\_point\_probes.py}), the
scripts \texttt{level2\_numeric.py} and \texttt{level2\_sampled.py}, the
Lean file \texttt{D4Closure.lean} and the scripts of the figures of
\cref{sec:closure} were developed with the
