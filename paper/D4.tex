...
$\sum_i\delta_i\le1.5\cdot10^{-3}$, and their directions $W$ satisfy
...
$\kappa\le2(1+\delta)S$. Consequently $\|\varepsilon\|\le4.25\,S$ and
$\Theta\le\|\varepsilon\|+S\le5.25\,S\le8\cdot10^{-3}$.
...
second order in $S$, through $\|\varepsilon\|\le4.25\,S$, with no factor of
...
all divided by $S$ and evaluated at $\|\varepsilon\|=2c_a(1+S)S$, $e=\|\varepsilon\|$,
...
$\beta$ in exact rational arithmetic and finds $\beta(1.5\cdot10^{-3})\ge0.2$:
at that point the moment term costs $0.41\,S$, the volume term $0.02\,S$,
the caps $10^{-4}S$ and the hull $0.04\,S$ (and $\beta$ stays positive up to
$S=2\cdot10^{-3}$). So $\vol(V_c)>8$ unless $S=0$. If $S=0$, then $\kappa=0$, so $\varepsilon=0$ by
...
\cref{thm:near-contact} ends at $\sum\delta_i=1.5\cdot10^{-3}$. Letting the
...
a hundred. The facet-by-facet estimate of step (b) stays positive up to
$\sum\delta_i=2\cdot10^{-3}$, and the rigidity it rests on stops soon after, so
no sharpening of its constants closes that factor. The missing ingredient is
...
$\varepsilon_0=4\cdot10^{-26}$ and the neighbourhood $\sum\delta_i\le1.5\cdot10^{-3}$
