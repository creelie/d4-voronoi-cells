...
kind carried out in \cite{LLM24}. The first level cannot supply it
...
within $\sqrt6$, that the first level does not see.
...
\texttt{truncated\_search.py}, \texttt{count\_bound\_sqrt6.py} and
\texttt{explicit\_eps0.py}), the Lean file \texttt{D4Closure.lean} and the
scripts of the figures of \cref{sec:closure} were developed with the
