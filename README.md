...
## Directory Structure
  ...
  lean/               Five Lean 4 verifications: the equilibrium stress of
                        ...
                        The first three need no Mathlib and no lakefile:
                        run "lean D4Stress.lean", "lean D4Meet.lean" and
                        "lean D4Certificate.lean" with any Lean 4
...
## hessian_multidir/ -- file-by-file map to paper sections
  ...
  a18_stabilizer_group.py    Identifies A_18's own exact symmetry. Within the full 384-element
                              ...
                              "a18-stabiliser" in Section 18.5 of the paper.
  ...
  a18_nullspace_irrep_match.py
                              ...
                              This is Proposition "a18-nullspace-irrep" in
                              Section 18.6 of the paper.
  ...
  a18_invariant_quartic_basis.py
                              ...
                              proof) in Section 18.6 of the paper.
  ...
  a18_fit_and_sos_check.py
                              ...
                              Proposition "a18-sos-reduced" in Section 18.6
...
## multi_cap/ -- the 23-point case, reformulated and settled
  ...
  inradius_search.py
                              Supports Section 7.9. Maximises the inradius
  ...
  truncated_volume.py
                              Supports Section 7.10. Evaluates the volume
  ...
  runs/                       The recorded output of the runs quoted in
                              ...
                              table in Section 7.9 takes the largest
                              ...
                              Clarabel 0.11, mpmath 1.3, sympy 1.14 and
                              Python 3.11; the endpoints of the searches
  ...
  slack_continuation.py
                              Supports Section 7.9 and its table. For
...
and D4Certificate.lean and lean/certificate/D4CertData.lean are
regenerated from the certificate file with
